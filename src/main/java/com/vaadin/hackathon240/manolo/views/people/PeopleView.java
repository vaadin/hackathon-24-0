package com.vaadin.hackathon240.manolo.views.people;
...
@PageTitle("People")
@Route(value = "people/:samplePersonID?/:action?(edit)")
@PermitAll
@Tag("people-view")
@JsModule("./views/people/people-view.ts")
@Uses(Icon.class)
public class PeopleView extends LitTemplate implements HasStyle, BeforeEnterObserver {
